...
export function trileanResult(card: ReturnType<typeof tpl.addCard>, g1: Geometry, g2: Geometry, result: Trilean) {
    ...
    view.add(new ViewElement(g2, { type: ViewElementType.None, ...strokeOnly("blue") }));
...
export function arrayResult(card: ReturnType<typeof tpl.addCard>, g1: Geometry, g2: Geometry, result: Geometry[]) {
    ...
    view.add(new ViewElement(shapeArray, { type: ViewElementType.None, ...strokeOnly("purple") }));
    view.add(new ViewElement(g1, { type: ViewElementType.None, ...strokeOnly("red") }));
    view.add(new ViewElement(g2, { type: ViewElementType.None, ...strokeOnly("blue") }));
...
export function quadraticBezierViewBundle(
    ...
    return {
        quadraticBezier: new ViewElement(quadraticBezier, { type: ViewElementType.None, ...curveStyle }),
        point1: new ViewElement(points[0], { ...endpointStyle }),
        point2: new ViewElement(points[1], { ...endpointStyle }),
        controlPoint: new ViewElement(points[2], { ...controlPointStyle }),
        controlSegment1: new ViewElement(controlSegment1, { type: ViewElementType.None, ...controlSegmentStyle }),
        controlSegment2: new ViewElement(controlSegment2, { type: ViewElementType.None, ...controlSegmentStyle })
    };
}
...
export function bezierViewBundle(
    ...
    return {
        bezier: new ViewElement(bezier, { type: ViewElementType.None, ...curveStyle }),
        point1: new ViewElement(points[0], { ...endpointStyle }),
        point2: new ViewElement(points[1], { ...endpointStyle }),
        controlPoint1: new ViewElement(points[2], { ...controlPointStyle }),
        controlPoint2: new ViewElement(points[3], { ...controlPointStyle }),
        controlSegment1: new ViewElement(controlSegment1, { type: ViewElementType.None, ...controlSegmentStyle }),
        controlSegment2: new ViewElement(controlSegment2, { type: ViewElementType.None, ...controlSegmentStyle }),
        controlSegment3: new ViewElement(controlSegment3, { type: ViewElementType.None, ...controlSegmentStyle })
    };
}
