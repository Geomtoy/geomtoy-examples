...
}
{
    tpl.addSection("separate", true);
    {
        ...
        const arc = Arc.fromCenterPointAndStartEndAnglesEtc([0, 0], 10, 5, (3 * Maths.PI) / 4, -Maths.PI / 3, true);
...
}
{
    tpl.addSection("intersect", true);
    {
        ...
        const arc = Arc.fromCenterPointAndStartEndAnglesEtc([0, 0], 10, 5, (4 * Maths.PI) / 3, -Maths.PI / 4, false, Maths.PI / 3);
    ...
    }
    {
        ...
        const arc = Arc.fromCenterPointAndStartEndAnglesEtc([0, 0], 10, 5, (3 * Maths.PI) / 4, -Maths.PI / 3, true, Maths.PI / 2);
        const ellipse = new Ellipse([0, 0], 10, 5, Maths.PI / 4);
        arrayResult(card, arc, ellipse, inter.intersect(arc, ellipse));
    }
    {
        const card = tpl.addCard({ title: "3 points intersect" });
        const arc = Arc.fromCenterPointAndStartEndAnglesEtc([0, 0], 20, 5, 0, -Maths.PI / 2, true, Maths.PI / 3);
        const ellipse = new Ellipse([-2, -2], 20, 5, Maths.PI / 4);
        arrayResult(card, arc, ellipse, inter.intersect(arc, ellipse));
    }
    {
        const card = tpl.addCard({ title: "4 points intersect" });
        const arc = Arc.fromCenterPointAndStartEndAnglesEtc([0, 0], 5, 15, -Maths.PI / 2, (-2 * Maths.PI) / 3, true);
        const ellipse = new Ellipse([2, 2], 20, 5, Maths.PI / 4);
        arrayResult(card, arc, ellipse, inter.intersect(arc, ellipse));
    }
}
{
    ...
    }
    {
        ...
        const arc = Arc.fromCenterPointAndStartEndAnglesEtc([0, 0], 10, 5, (4 * Maths.PI) / 3, -Maths.PI / 4, false);
...
}
{
    tpl.addSection("contact/touch", true);
    {
        ...
        const arc = Arc.fromCenterPointAndStartEndAnglesEtc([-10, 0], 10, 5, Maths.PI / 2, 0, false);
    ...
    }
    {
        ...
        const arc = Arc.fromCenterPointAndStartEndAnglesEtc([0, 2.193357483982], 5, 10, (4 * Maths.PI) / 3, -Maths.PI / 4, false, Maths.PI / 2);
        const ellipse = new Ellipse([-10, -10], 10, 5, Maths.PI / 2);
        arrayResult(card, arc, ellipse, inter.intersect(arc, ellipse));
    }
}
...
}
{
    tpl.addSection("blockedBy", true);
    {
        ...
        const arc = Arc.fromCenterPointAndStartEndAnglesEtc([-5, 5], 10, 5, 0, -Maths.PI / 2, false);
