...
import { codeHtml, fillOnly, lightStrokeFill, lightStrokeFillTrans, markdownHtml, normalFont, strokeFillTrans } from "../../assets/common";
...
const image2 = new Image(0, 0, 36, 36, 560, 540, 360, 360, imageUrl, false, Anchor.LeftCenter);
    ...
    card.appendDescription(markdownHtml(`See more info: [Image explanation](/basic/image/explanation.html)`));
