...
tpl.title("Rectangle-rectangle boolean operation");

const rectangle1 = new Rectangle(20, 20, 60, 60);
const rectangle2 = new Rectangle(-20, -20, 60, 60);

const bo = new BooleanOperation();

const description = bo.describe(rectangle1.toPath(), rectangle2.toPath());
