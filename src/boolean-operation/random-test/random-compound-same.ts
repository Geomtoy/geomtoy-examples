...
tpl.title("Same random compound-compound test");
...
tpl.addMarkdown(`
Refresh to random. The two compounds are exactly the same.(One is a clone of the other.)
Each of the two compounds contain 2 identical paths with 5 random commands. 
`);
{
