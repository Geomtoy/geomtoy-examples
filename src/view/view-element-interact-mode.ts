...
- \`ViewElementInteractMode.None\`: The view element is not interactable. It is only meant to be displayed without any interaction.
- \`ViewElementInteractMode.Activation\`: The view element is interactable and can also be activated. The activated view elements is a 
...
- \`ViewElementInteractMode.Operation\`: The view element is interactable but can NOT be activated. The operated view element corresponds to 
